    ...
    <div class="mx-auto" style="max-width: 1111px;padding-top: 100px">
        <div class="row mx-auto">
            ...
            <div class="col-lg-4 mx-auto">
                ...
                <div class="botones text-right">
                    <a href="{{ route('noticias.index') }}" class=""><img src="{{ asset('images/icons/show.png') }}" alt="show"></a>
                    <a href="{{ route('noticias.create') }}" class="ml-2"><img src="{{ asset('images/icons/create.png') }}" alt="create"></a>
        ...
        <div class="row mx-auto space-between">
            ...
            <div class="col-lg-4">
                ...
                <div class="botones text-right">
                    <a href="{{ route('deportes.index') }}" class=""><img src="{{ asset('images/icons/show.png') }}" alt="show"></a>
                    <a href="{{ route('deportes.create') }}" class="ml-2"><img src="{{ asset('images/icons/create.png') }}" alt="create"></a>
